...
class PythonPlaygroundViewModel(private val pythonRepository: PythonRepository) : ViewModel() {
    companion object {
...
//        of pattern [File "<string>,"]
    ...
    fun getCachedCode() = pythonRepository.getCachedCode()

    fun cacheCode(code: String) = pythonRepository.cacheCode(code)
    fun saveCode(code: String, fileName: String) {
        pythonRepository.saveCode(code,fileName)
    }
