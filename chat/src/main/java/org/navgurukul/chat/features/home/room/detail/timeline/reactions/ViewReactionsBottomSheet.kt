...
import org.navgurukul.chat.databinding.BottomSheetGenericListWithTitleBinding
...
class ViewReactionsBottomSheet : BottomSheetDialogFragment(),
    ...
    private lateinit var binding: BottomSheetGenericListWithTitleBinding
    ...
    override fun onCreateView(
        ...
        binding = BottomSheetGenericListWithTitleBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.bottomSheetRecyclerView.configureWith(epoxyController, hasFixedSize = false, showDivider = true)
        binding.bottomSheetTitle.text = context?.getString(R.string.reactions)
    ...
    override fun onDestroyView() {
        binding.bottomSheetRecyclerView.cleanup()
