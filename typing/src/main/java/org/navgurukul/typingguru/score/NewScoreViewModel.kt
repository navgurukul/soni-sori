...
class NewScoreViewModel(scoreActivityArgs: NewScoreActivityArgs, stringProvider: StringProvider) :
    BaseViewModel<EmptyViewEvents, NewScoreViewState>(NewScoreViewState()) {
