...
import kotlinx.android.synthetic.main.incorrect_output_layout.view.btnRetry
import kotlinx.android.synthetic.main.incorrect_output_layout.view.btnSeeExplanation
import kotlinx.android.synthetic.main.incorrect_output_layout.view.explanationRetryLayout
import kotlinx.android.synthetic.main.incorrect_output_layout.view.incorrectRv
...
import org.navgurukul.learn.databinding.FragmentModuleAssessmentBinding
...
class ModuleAssessmentFragment : Fragment() {

    private val args: CourseContentArgs by fragmentArgs()
    private lateinit var mBinding: FragmentModuleAssessmentBinding
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_module_assessment, container, false)
