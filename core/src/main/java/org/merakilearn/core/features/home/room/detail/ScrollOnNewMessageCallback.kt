...
import org.navgurukul.chat.features.home.room.detail.timeline.item.BaseEventItem
...
class ScrollOnNewMessageCallback(private val layoutManager: LinearLayoutManager,
    ...
    override fun onInserted(position: Int, count: Int) {
        ...
        val firstNewItem = timelineEventController.adapter.getModelAtPosition(position) as? BaseEventItem
            ?: return
