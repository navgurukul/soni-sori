...
import org.merakilearn.core.features.attachmentviewer.AttachmentEventListener
import org.merakilearn.core.features.attachmentviewer.AttachmentEvents
...
class AttachmentOverlayView @JvmOverloads constructor(
    ...
    override fun onEvent(event: org.merakilearn.core.features.attachmentviewer.AttachmentEvents) {
        when (event) {
            is org.merakilearn.core.features.attachmentviewer.AttachmentEvents.VideoEvent -> {
