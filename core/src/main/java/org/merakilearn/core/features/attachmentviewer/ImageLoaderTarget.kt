...
internal class DefaultImageLoaderTarget(val holder: org.merakilearn.core.features.attachmentviewer.AnimatedImageViewHolder, private val contextView: ImageView)
    : ImageLoaderTarget {
