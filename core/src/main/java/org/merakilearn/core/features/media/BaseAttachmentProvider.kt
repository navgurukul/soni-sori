...
import org.merakilearn.core.features.attachmentviewer.AttachmentInfo
import org.merakilearn.core.features.attachmentviewer.AttachmentSourceProvider
...
abstract class BaseAttachmentProvider(
    ...
    _root_ide_package_.org.merakilearn.core.features.attachmentviewer.AttachmentSourceProvider {
    ...
    override fun loadImage(target: ImageLoaderTarget, info: _root_ide_package_.org.merakilearn.core.features.attachmentviewer.AttachmentInfo.Image) {
    ...
    override fun loadImage(target: ImageLoaderTarget, info: _root_ide_package_.org.merakilearn.core.features.attachmentviewer.AttachmentInfo.AnimatedImage) {
        (info.data as? ImageContentRenderer.Data)?.let {
            imageContentRenderer.render(
                it,
                target.contextView(),
    ...
    override fun loadVideo(target: VideoLoaderTarget, info: _root_ide_package_.org.merakilearn.core.features.attachmentviewer.AttachmentInfo.Video) {
