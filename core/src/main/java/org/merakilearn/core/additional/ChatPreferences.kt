...
//        const val SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY = "SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY"
    ...
    fun shouldShowHiddenEvents(): Boolean {
        return developerMode() && defaultPrefs.getBoolean(
            SETTINGS_LABS_SHOW_HIDDEN_EVENTS_PREFERENCE_KEY, false)
    }
...
//        return BuildConfig.DEBUG || (developerMode() && defaultPrefs.getBoolean(
//            SETTINGS_DEVELOPER_MODE_FAIL_FAST_PREFERENCE_KEY, false))
//    }
