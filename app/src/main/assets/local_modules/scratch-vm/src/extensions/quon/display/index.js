...
class quonDisplay {
    ...
    _onTargetCreated(newTarget, sourceTarget) {
        if (sourceTarget) {
            const quonDisplayState = sourceTarget.getCustomState(quonDisplay.STATE_KEY);
            if (quonDisplayState) {
                newTarget.setCustomState(quonDisplay.STATE_KEY, Clone.simple(quonDisplayState));
            }
        }
    }
    ...
    getInfo() {
        return {
            ...
            blocks: [
                {
                    opcode: 'enableHeaderBlock',
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: 'quonDisplay.enableHeaderBlock',
                        default: '[STATUS] status block',              //decide final name
                        description: 'to show and hide status bar'
                    }),
                    arguments: {
                        STATUS: {
                ...
                },
                {
                    message: formatMessage({
                        id: 'quonDisplay.blockSeparatorMessage1',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: `quonDisplay.displayimage`,
                        default: `set [NAME] as[IMAGE] and display at [X_AXIS] , [Y_AXIS] width [WIDTH] height [HEIGHT]`,
                    ...
                    arguments: {
                        ...
                        X_AXIS: {
                            type: ArgumentType.MATHSLIDER320,
                            defaultValue: '10'
                        },
                        Y_AXIS: {
                ...
                {
                    message: formatMessage({
                        id: 'quonDisplay.blockSeparatorMessage2',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: 'quonDisplay.setTextColorSize',
                ...
                {
                    message: formatMessage({
                        id: 'quonDisplay.blockSeparatorMessage3',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: 'quonDisplay.fillDrawRoundRect',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: 'quonDisplay.fillDrawEllipse',
                ...
                },
                {
                    ...
                    blockType: BlockType.COMMAND,
                    text: formatMessage({
                        id: 'quonDisplay.fillDrawTriangle',
            ...
            menus: {
                ...
                statusMenu: [
                    {
                        text: formatMessage({
                            id: 'extension.menu.statusMenus.option1',
                            default: 'Enable',
                            description: 'Menu'
                        }), value: '1'
                    },
                    {
                        text: formatMessage({
                            id: 'extension.menu.statusMenus.option2',
                            default: 'Disable',
                            description: 'Menu'
                        }), value: '0'
                    }
    ...
    enableHeaderBlock(args, util) {
        if (this.runtime.getCode) {
            return CodingMode.enableHeaderBlock(args, util, this);
        }
        return RealtimeMode.enableHeaderBlock(args, util, this);
    }
