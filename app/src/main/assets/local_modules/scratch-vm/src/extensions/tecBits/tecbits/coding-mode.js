...
const isSensorTouched = (args, util) => {
    util.runtime.include.add(`#include <tecBits.h>\n`);
	return `sensor${args.SENSORPIN}.getTecBitsTouchValue(${args.STATUS},${args.SENSORTHRESHOLD})`; 
};
