        ...
        viewModelScope.launch {
            ...
            classes?.let {
                ...
                var primaryActionBackgroundColor =
                    colorProvider.getColorFromAttribute(org.matrix.android.sdk.R.attr.colorPrimary)
                ...
                if (result) {
                    ...
                    setState {
                        copy(
                            ...
                            menuId = null,
                            primaryActionBackgroundColor = colorProvider.getColorFromAttribute(com.airbnb.lottie.R.attr.colorPrimary)
                        )
                    }
        ...
        viewModelScope.launch {
            ...
            if (isEnrolled) {
                ...
                if (result) {
                    ...
                    val durationToClassStart = (classes.startTime.time - Date().time)
                    var primaryActionBackgroundColor =
                        colorProvider.getColorFromAttribute(com.airbnb.lottie.R.attr.colorPrimary)
