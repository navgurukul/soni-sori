...
val networkModule = module {
    ...
    fun provideMoshi(): Moshi {
        return Moshi.Builder()
            ...
            .add(
                PolymorphicJsonAdapterFactory.of(ExerciseSlugDetail::class.java, "component")
                .withSubtype(ImageExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_IMAGE)
                .withSubtype(TextExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_TEXT)
                .withSubtype(LinkExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_LINK)
//                .withSubtype(CodeExerciseSlugDetail::class.java, ExerciseSlugDetail.TYPE_SOLUTION)
                .withSubtype(CodeExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_CODE)
                .withSubtype(BlockQuoteExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_BLOCK_QUOTE)
                ...
                .withSubtype(YoutubeExerciseSlugDetail::class.java, ExerciseSlugDetail.COMPONENT_YOUTUBE_VIDEO)
