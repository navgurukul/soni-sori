...
public class UsbSerialManager {
    ...
    public static final String ACTION_USB_NOT_SUPPORTED = "org.merakilearn.arduinohexupload.device.USB_NOT_SUPPORTED";
    public static final String ACTION_NO_USB = "org.merakilearn.arduinohexupload.device.NO_USB";
    public static final String ACTION_USB_PERMISSION_GRANTED = "org.merakilearn.arduinohexupload.device.USB_PERMISSION_GRANTED";
    public static final String ACTION_USB_PERMISSION_NOT_GRANTED = "org.merakilearn.arduinohexupload.device.USB_PERMISSION_NOT_GRANTED";
    public static final String ACTION_USB_PERMISSION_REQUEST = "org.merakilearn.arduinohexupload.device.ACTION_USB_PERMISSION_REQUEST";
    public static final String ACTION_USB_DISCONNECTED = "org.merakilearn.arduinohexupload.device.ACTION_USB_DISCONNECTED";
    public static final String ACTION_USB_CONNECT = "org.merakilearn.arduinohexupload.device.ACTION_USB_CONNECT";
    public static final String ACTION_USB_READY = "org.merakilearn.arduinohexupload.device.USB_READY";
    public static final String ACTION_CDC_DRIVER_NOT_WORKING = "org.merakilearn.arduinohexupload.ACTION_CDC_DRIVER_NOT_WORKING";
    public static final String ACTION_USB_DEVICE_NOT_WORKING = "org.merakilearn.arduinohexupload.device.ACTION_USB_DEVICE_NOT_WORKING";
